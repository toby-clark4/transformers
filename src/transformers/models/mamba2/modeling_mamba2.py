...
@dataclass
# Copied from transformers.models.mamba.modeling_mamba.MambaMaskedLMOutput with Mamba->Mamba2
class Mamba2MaskedLMOutput(ModelOutput):
    """
...
class Mamba2ForMaskedLM(Mamba2PreTrainedModel, GenerationMixin):
    _tied_weights_keys = []
    ...
    def forward(
        ...
        attention_mask: Optional[torch.Tensor] = None,
        **kwargs,
    ) -> Union[Tuple, Mamba2MaskedLMOutput]:
        r"""
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
